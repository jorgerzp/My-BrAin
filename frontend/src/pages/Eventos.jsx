...
export default function Eventos() {
  ...
  return (
    <DashboardLayout>
        ...
        <div className="ev-desc-center">
          <p className="dash-sub">
            Planifica fechas importantes y crea huchas con meta de ahorro. El dinero que aportas a cada hucha se registra aquí y se refleja en Finanzas como movimiento de ahorro.
          </p>
        </div>
